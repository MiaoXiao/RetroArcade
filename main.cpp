...
int main() {
    ...
    while (LetsPlay == 'y') {
        ...
        else if (Option == "5") { Hangman THREE; THREE.play(); Hang.prompt(THREE.score); }
        else if (Option == "6") { cout << "\033c"; Hang.display(); }
        else if (Option == "7") { return 0; }

        cout << "\033c" << "Would you like to do something else? (NO SPACES) (y/n) ";
        cin >> LetsPlay;
